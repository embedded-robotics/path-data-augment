...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True):
        ...
        self.logger_log_images = dict()
        if hasattr(pl.loggers, "WandbLogger"):
...
if __name__ == "__main__":
    ...
    try:
        ...
        # default to ddp on legacy Lightning versions
        if hasattr(Trainer, "add_argparse_args"):
        ...
        if hasattr(Trainer, "from_argparse_args"):
            ...
            trainer = Trainer(**dict(trainer_config), **trainer_kwargs)
